...
console.log(
  "- API URL charCodeAt end-1:",
  API_URL.charCodeAt(API_URL.length - 1)
);
console.log(
  "- API URL charCodeAt end-2:",
  API_URL.charCodeAt(API_URL.length - 2)
);
console.log(
  "- API URL charCodeAt end-3:",
  API_URL.charCodeAt(API_URL.length - 3)
);
console.log(
  "- API URL charCodeAt end-4:",
  API_URL.charCodeAt(API_URL.length - 4)
);
